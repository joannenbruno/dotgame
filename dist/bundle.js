...
module.exports = __webpack_require__(/*! C:\Users\jnbru\Documents\BitBucket\dotgame\src\main.js */333);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    key: 'init',
    value: function init() {
      this.stage.backgroundColor = '#00BCD4';
    ...
    value: function preload() {
      ...
      var text = this.add.text(this.world.centerX, this.world.centerY, 'loading fonts', { font: '16px Arial', fill: '#ffffff', align: 'center' });
...
var _Bubble = __webpack_require__(/*! ../sprites/Bubble */ 342);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.line = new _phaser2.default.Line(0, 150, game.world.width, 150);
      this.createSlider();
      this.createGameStateButton();

      /* BUBBLE GAME */
      game.time.events.loop(_phaser2.default.Timer.SECOND, this.createBubble, this);
    }
  }, {
    key: 'createSlider',
    ...
    key: 'setVelocityOnStop',
    value: function setVelocityOnStop() {
    ...
    key: 'createGameStateButton',
    value: function createGameStateButton() {
    ...
    key: 'unpause',
    value: function unpause(gameStateButton) {
      game.paused = false;
    ...
    value: function createBubble() {
      this.bubble = new _Bubble2.default({
        game: this.game,
      ...
      game.physics.enable([this.bubble], _phaser2.default.Physics.ARCADE);
    ...
    key: 'pop',
    value: function pop(selectedBubble) {
    ...
    key: 'updateScore',
    value: function updateScore(selectedBubble) {
    ...
    set: function set(velocityIncrease) {
